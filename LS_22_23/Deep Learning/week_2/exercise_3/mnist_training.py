...
# 3d76595a-e687-11e9-9ce9-00505601122b se spatnym humorem
...
parser.add_argument("--epochs", default=2, type=int, help="Number of epochs.") #10
parser.add_argument("--hidden_layer", default=200, type=int, help="Size of the hidden layer.")
parser.add_argument("--learning_rate", default=0.01, type=float, help="Initial learning rate.")
parser.add_argument("--learning_rate_final", default=0.001, type=float, help="Final learning rate.") #None
...
def main(args: argparse.Namespace) -> Dict[str, float]:
    ...
    print(model.optimizer.learning_rate, args.learning_rate_final)
