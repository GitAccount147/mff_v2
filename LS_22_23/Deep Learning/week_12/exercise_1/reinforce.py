...
parser.add_argument("--seed", default=None, type=int, help="Random seed.") # None
parser.add_argument("--threads", default=1, type=int, help="Maximum number of threads to use.")
# For these and any other arguments you add, ReCodEx will keep your default value.
parser.add_argument("--batch_size", default=100, type=int, help="Batch size.")
parser.add_argument("--episodes", default=2200, type=int, help="Training episodes.")
parser.add_argument("--hidden_layer_size1", default=100, type=int, help="Size of hidden layer.")
...
class Agent:
    def __init__(self, env: wrappers.EvaluationEnv, args: argparse.Namespace) -> None:
        ...
        model = tf.keras.Sequential([
            ...
            tf.keras.layers.Dense(args.hidden_layer_size1, activation=tf.nn.tanh),
            tf.keras.layers.Dense(args.hidden_layer_size2, activation=tf.nn.tanh),
    ...
    def train(self, states: np.ndarray, actions: np.ndarray, returns: np.ndarray) -> None:
        ...
        with tf.GradientTape() as tape:
            ...
            loss = self._model.compute_loss(states, tf.one_hot(actions, 2), prob, sample_weight=returns)
